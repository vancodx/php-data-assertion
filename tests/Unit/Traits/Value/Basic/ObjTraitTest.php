...
class ObjTraitTest extends BasicTraitsTestCase
{
    ...
    {
        $this->expectExceptionIfNot($isCorrect, ValueException::class);
        A::valueIsObjOf($value, MyArrayObject1::class);
    }
    ...
    {
        $this->expectExceptionIfNot($isCorrect, ValueException::class);
        A::valueIsObjOf($value, MyArrayObject2::class);
    }
    ...
    {
        $this->expectExceptionIfNot($isCorrect, ValueException::class);
        A::valueIsClsOf($value, MyArrayObject1::class);
    }
    ...
    {
        $this->expectExceptionIfNot($isCorrect, ValueException::class);
        A::valueIsClsOf($value, MyArrayObject2::class);
    }
}

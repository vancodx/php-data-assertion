...
class ExceptionTraitTest extends MockeryTestCase
{
    ...
    {
        $exception = ExceptionTraitObject::newValueException('name1');
    ...
    {
        $exception = ExceptionTraitObject::newValueException(['first_name2', 'second_name2'], 32);
        $expectedLine = __LINE__ - 1;
        $this->assertInstanceOf(ValueException::class, $exception);
    ...
    {
        $exception = ExceptionTraitObject::newArgumentException('name1');
        $expectedLine = __LINE__ - 1;
    ...
    {
        $exception = ExceptionTraitObject::newArgumentException(['first_name2', 'second_name2'], 32);
        $expectedLine = __LINE__ - 1;
        $this->assertInstanceOf(ArgumentException::class, $exception);

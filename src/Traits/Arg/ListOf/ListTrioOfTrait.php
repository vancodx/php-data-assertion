...
trait ListTrioOfTrait
{
     ...
     */
    public static function argIsListTrioOf(mixed $value, callable $validator, string $varName = null): void
    {
     ...
     */
    public static function argIsListTrioOfBool(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function argIsListTrioOfInt(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function argIsListTrioOfUInt(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function argIsListTrioOfPosInt(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function argIsListTrioOfNegInt(mixed $value, string $varName = null): void
    {
     ...
     * @phpstan-assert array{0: positive-int, 1: positive-int, 2: positive-int} $value
     */
    public static function argIsListTrioOfIntId(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function argIsListTrioOfFloat(mixed $value, string $varName = null): void
    {
     ...
     * @phpstan-assert array{0: float, 1: float, 2: float} $value
     */
    public static function argIsListTrioOfUFloat(mixed $value, string $varName = null): void
    {
     ...
     * @phpstan-assert array{0: float, 1: float, 2: float} $value
     */
    public static function argIsListTrioOfPosFloat(mixed $value, string $varName = null): void
    {
     ...
     * @phpstan-assert array{0: float, 1: float, 2: float} $value
     */
    public static function argIsListTrioOfNegFloat(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function argIsListTrioOfNum(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function argIsListTrioOfUNum(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function argIsListTrioOfPosNum(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function argIsListTrioOfNegNum(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function argIsListTrioOfStr(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function argIsListTrioOfStrLen(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function argIsListTrioOfRes(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function argIsListTrioOfObj(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function argIsListTrioOfCls(mixed $value, string $varName = null): void
    {
     ...
     * @phpstan-assert array{0: class-string, 1: class-string, 2: class-string} $value
     */
    public static function argIsListTrioOfIfc(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function argIsListTrioOfObjOf(mixed $value, string $class, string $varName = null): void
    {
     ...
     */
    public static function argIsListTrioOfClsOf(mixed $value, string $class, string $varName = null): void
    {

...
trait AssocSoloOfTrait
{
     ...
     */
    public static function argIsAssocSoloOf(mixed $value, callable $validator, string $argName = null): void
    {
     ...
     */
    public static function argIsAssocSoloOfBool(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function argIsAssocSoloOfInt(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function argIsAssocSoloOfUInt(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function argIsAssocSoloOfPosInt(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function argIsAssocSoloOfNegInt(mixed $value, string $argName = null): void
    {
     ...
     * @phpstan-assert array{non-empty-string: positive-int} $value
     */
    public static function argIsAssocSoloOfIntId(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function argIsAssocSoloOfFloat(mixed $value, string $argName = null): void
    {
     ...
     * @phpstan-assert array{non-empty-string: float} $value
     */
    public static function argIsAssocSoloOfUFloat(mixed $value, string $argName = null): void
    {
     ...
     * @phpstan-assert array{non-empty-string: float} $value
     */
    public static function argIsAssocSoloOfPosFloat(mixed $value, string $argName = null): void
    {
     ...
     * @phpstan-assert array{non-empty-string: float} $value
     */
    public static function argIsAssocSoloOfNegFloat(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function argIsAssocSoloOfNum(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function argIsAssocSoloOfUNum(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function argIsAssocSoloOfPosNum(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function argIsAssocSoloOfNegNum(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function argIsAssocSoloOfStr(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function argIsAssocSoloOfStrLen(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function argIsAssocSoloOfRes(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function argIsAssocSoloOfObj(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function argIsAssocSoloOfCls(mixed $value, string $argName = null): void
    {
     ...
     * @phpstan-assert array{non-empty-string: class-string} $value
     */
    public static function argIsAssocSoloOfIfc(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function argIsAssocSoloOfObjOf(mixed $value, string $class, string $argName = null): void
    {
     ...
     */
    public static function argIsAssocSoloOfClsOf(mixed $value, string $class, string $argName = null): void
    {

...
trait IntOrNullTrait
{
     ...
     */
    public static function argIsIntOrNull(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function argIsUIntOrNull(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function argIsPosIntOrNull(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function argIsNegIntOrNull(mixed $value, string $argName = null): void
    {
     ...
     * @phpstan-assert positive-int|null $value
     */
    public static function argIsIntIdOrNull(mixed $value, string $argName = null): void
    {

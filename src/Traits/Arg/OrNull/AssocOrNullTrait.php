...
trait AssocOrNullTrait
{
     ...
     */
    public static function argIsAssocOrNull(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function argIsAssocLenOrNull(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function argIsEmptyAssocOrNull(mixed $value, string $varName = null): void
    {
     ...
     * @phpstan-assert array{non-empty-string: mixed}|null $value
     */
    public static function argIsAssocSoloOrNull(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function argIsAssocDuoOrNull(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function argIsAssocTrioOrNull(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function argIsAssocQuadOrNull(mixed $value, string $varName = null): void
    {

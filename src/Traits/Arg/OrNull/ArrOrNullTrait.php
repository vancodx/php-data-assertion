...
trait ArrOrNullTrait
{
     ...
     */
    public static function argIsArrOrNull(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function argIsArrLenOrNull(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function argIsEmptyArrOrNull(mixed $value, string $argName = null): void
    {
     ...
     * @phpstan-assert array{mixed}|null $value
     */
    public static function argIsArrSoloOrNull(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function argIsArrDuoOrNull(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function argIsArrTrioOrNull(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function argIsArrQuadOrNull(mixed $value, string $argName = null): void
    {

...
trait AssocTrait
{
     ...
     */
    public static function argIsAssoc(mixed $value, string $argName = null): void
    {
        if (!V::isAssoc($value)) {
     ...
     */
    public static function argIsAssocLen(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function argIsEmptyAssoc(mixed $value, string $argName = null): void
    {
     ...
     * @phpstan-assert array{non-empty-string: mixed} $value
     */
    public static function argIsAssocSolo(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function argIsAssocDuo(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function argIsAssocTrio(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function argIsAssocQuad(mixed $value, string $argName = null): void
    {

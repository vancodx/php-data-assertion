...
trait ArrQuadOfTrait
{
     ...
     */
    public static function valueIsArrQuadOf(mixed $value, callable $validator, string $varName = null): void
    {
     ...
     */
    public static function valueIsArrQuadOfBool(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function valueIsArrQuadOfInt(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function valueIsArrQuadOfUInt(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function valueIsArrQuadOfPosInt(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function valueIsArrQuadOfNegInt(mixed $value, string $varName = null): void
    {
     ...
     * @phpstan-assert array{positive-int, positive-int, positive-int, positive-int} $value
     */
    public static function valueIsArrQuadOfIntId(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function valueIsArrQuadOfFloat(mixed $value, string $varName = null): void
    {
     ...
     * @phpstan-assert array{float, float, float, float} $value
     */
    public static function valueIsArrQuadOfUFloat(mixed $value, string $varName = null): void
    {
     ...
     * @phpstan-assert array{float, float, float, float} $value
     */
    public static function valueIsArrQuadOfPosFloat(mixed $value, string $varName = null): void
    {
     ...
     * @phpstan-assert array{float, float, float, float} $value
     */
    public static function valueIsArrQuadOfNegFloat(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function valueIsArrQuadOfNum(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function valueIsArrQuadOfUNum(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function valueIsArrQuadOfPosNum(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function valueIsArrQuadOfNegNum(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function valueIsArrQuadOfStr(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function valueIsArrQuadOfStrLen(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function valueIsArrQuadOfRes(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function valueIsArrQuadOfObj(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function valueIsArrQuadOfCls(mixed $value, string $varName = null): void
    {
     ...
     * @phpstan-assert array{class-string, class-string, class-string, class-string} $value
     */
    public static function valueIsArrQuadOfIfc(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function valueIsArrQuadOfObjOf(mixed $value, string $class, string $varName = null): void
    {
     ...
     */
    public static function valueIsArrQuadOfClsOf(mixed $value, string $class, string $varName = null): void
    {

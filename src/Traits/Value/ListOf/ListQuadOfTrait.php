...
trait ListQuadOfTrait
{
     ...
     */
    public static function valueIsListQuadOf(mixed $value, callable $validator, string $varName = null): void
    {
     ...
     */
    public static function valueIsListQuadOfBool(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function valueIsListQuadOfInt(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function valueIsListQuadOfUInt(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function valueIsListQuadOfPosInt(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function valueIsListQuadOfNegInt(mixed $value, string $varName = null): void
    {
     ...
     * @phpstan-assert array{0: positive-int, 1: positive-int, 2: positive-int, 3: positive-int} $value
     */
    public static function valueIsListQuadOfIntId(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function valueIsListQuadOfFloat(mixed $value, string $varName = null): void
    {
     ...
     * @phpstan-assert array{0: float, 1: float, 2: float, 3: float} $value
     */
    public static function valueIsListQuadOfUFloat(mixed $value, string $varName = null): void
    {
     ...
     * @phpstan-assert array{0: float, 1: float, 2: float, 3: float} $value
     */
    public static function valueIsListQuadOfPosFloat(mixed $value, string $varName = null): void
    {
     ...
     * @phpstan-assert array{0: float, 1: float, 2: float, 3: float} $value
     */
    public static function valueIsListQuadOfNegFloat(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function valueIsListQuadOfNum(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function valueIsListQuadOfUNum(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function valueIsListQuadOfPosNum(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function valueIsListQuadOfNegNum(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function valueIsListQuadOfStr(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function valueIsListQuadOfStrLen(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function valueIsListQuadOfRes(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function valueIsListQuadOfObj(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function valueIsListQuadOfCls(mixed $value, string $varName = null): void
    {
     ...
     * @phpstan-assert array{0: class-string, 1: class-string, 2: class-string, 3: class-string} $value
     */
    public static function valueIsListQuadOfIfc(mixed $value, string $varName = null): void
    {
     ...
     */
    public static function valueIsListQuadOfObjOf(mixed $value, string $class, string $varName = null): void
    {
     ...
     */
    public static function valueIsListQuadOfClsOf(mixed $value, string $class, string $varName = null): void
    {

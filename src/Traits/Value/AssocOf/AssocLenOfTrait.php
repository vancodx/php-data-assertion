...
trait AssocLenOfTrait
{
     ...
     */
    public static function valueIsAssocLenOf(mixed $value, callable $validator, string $argName = null): void
    {
     ...
     */
    public static function valueIsAssocLenOfBool(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function valueIsAssocLenOfInt(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function valueIsAssocLenOfUInt(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function valueIsAssocLenOfPosInt(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function valueIsAssocLenOfNegInt(mixed $value, string $argName = null): void
    {
     ...
     * @phpstan-assert non-empty-array<non-empty-string, positive-int> $value
     */
    public static function valueIsAssocLenOfIntId(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function valueIsAssocLenOfFloat(mixed $value, string $argName = null): void
    {
     ...
     * @phpstan-assert non-empty-array<non-empty-string, float> $value
     */
    public static function valueIsAssocLenOfUFloat(mixed $value, string $argName = null): void
    {
     ...
     * @phpstan-assert non-empty-array<non-empty-string, float> $value
     */
    public static function valueIsAssocLenOfPosFloat(mixed $value, string $argName = null): void
    {
     ...
     * @phpstan-assert non-empty-array<non-empty-string, float> $value
     */
    public static function valueIsAssocLenOfNegFloat(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function valueIsAssocLenOfNum(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function valueIsAssocLenOfUNum(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function valueIsAssocLenOfPosNum(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function valueIsAssocLenOfNegNum(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function valueIsAssocLenOfStr(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function valueIsAssocLenOfStrLen(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function valueIsAssocLenOfRes(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function valueIsAssocLenOfObj(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function valueIsAssocLenOfCls(mixed $value, string $argName = null): void
    {
     ...
     * @phpstan-assert non-empty-array<non-empty-string, class-string> $value
     */
    public static function valueIsAssocLenOfIfc(mixed $value, string $argName = null): void
    {
     ...
     */
    public static function valueIsAssocLenOfObjOf(mixed $value, string $class, string $argName = null): void
    {
     ...
     */
    public static function valueIsAssocLenOfClsOf(mixed $value, string $class, string $argName = null): void
    {
